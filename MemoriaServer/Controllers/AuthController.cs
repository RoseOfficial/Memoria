...
namespace MemoriaServer.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
            ...
            CancellationToken ct)
        {
            ...
            // 6. Set __Host-memoria cookie and redirect back to web
            Response.Cookies.Append("__Host-memoria", user.ApiKey, new CookieOptions
            {
                HttpOnly = true,
                Secure = true,
                SameSite = SameSiteMode.Lax,
        ...
        public async Task<IActionResult> GenerateLinkCode(CancellationToken ct)
        {
            ...
            return Ok(new MemoriaServer.Models.DTOs.LinkGenerateResponse(code, row.ExpiresAt));
        }
        ...
        public async Task<IActionResult> RedeemLinkCode([FromBody] MemoriaServer.Models.DTOs.LinkRedeemRequest request, CancellationToken ct)
        {
            ...
            Response.Cookies.Append("__Host-memoria", pluginUser.ApiKey, new CookieOptions
            {
                HttpOnly = true,
                Secure = true,
                SameSite = SameSiteMode.Lax,
        ...
        public IActionResult Logout()
        {
            ...
            Response.Cookies.Delete("__Host-memoria", new CookieOptions
            {
                Secure = true,
                SameSite = SameSiteMode.Lax,
                Path = "/",
