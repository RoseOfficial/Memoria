...
namespace AlphaScope.API.Security
{
    /// <summary>
    ...
    public static class SecureDataHandler
    {
        ...
        private static string ComputeSafeHash(string input)
        {
            ...
            var hash = sha256.ComputeHash(Encoding.UTF8.GetBytes(input + "AlphaScope_Salt"));
        ...
        private static byte[] GetMachineEntropy()
        {
            try
            {
                ...
                var combined = $"{machineId}|{osVersion}|{processorCount}|{userDomain}|AlphaScope";
            ...
            catch
            {
                ...
                return SHA256.HashData(Encoding.UTF8.GetBytes("AlphaScope_Fallback_Entropy_2024"));
            }
        }
