...
namespace AlphaScope.API.Extensions
{
    ...
    /// AlphaScope API integration. Simplifies API request building and response handling.
    /// </summary>
    public static class HttpClientExtensions
    {
        /// <summary>
        /// Creates a GET request with standardized configuration for AlphaScope API endpoints.
            ...
            object? parameters = null)
        {
            ...
            request.AddHeader("User-Agent", "AlphaScope/1.0");
        ...
        /// Supports API key authentication as used by the AlphaScope API.
        /// </summary>
        ...
        /// Handles the standard AlphaScope API response format with success/error structure.
        /// </summary>
