...
using AlphaScope.API.Models.Requests.User;
using UserModels = AlphaScope.API.Models.Responses.User;
...
{
    /// <summary>
    /// Modern, professional HTTP client for communicating with the AlphaScopeServer API.
