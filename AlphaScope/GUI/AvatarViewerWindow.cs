...
namespace AlphaScope.GUI
{
    ...
    {
        private const string WindowId = "###AlphaScopeAvatarViewer";
        ...
        public AvatarViewerWindow() : base("###AlphaScopeAvatarViewer", ImGuiWindowFlags.None)
        {
            if (_instance == null)
            {
                _instance = this;
        ...
        private void UpdateWindowTitle()
            => WindowName = $"AlphaScope - Avatar - {currentCharacterName}{WindowId}";
