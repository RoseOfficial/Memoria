...
namespace PlayerScopeServer.Controllers
{
    ...
    public class PlayersController : ControllerBase
    {
        ...
        public PlayersController(PlayerScopeDbContext context, ILogger<PlayersController> logger)
        {
            _context = context;
            _logger = logger;
        }
            ...
            try
            {
                ...
                _ = Task.Run(async () =>
                {
                    try
                    {
                        ...
                        var scopedContext = scope.ServiceProvider.GetRequiredService<PlayerScopeDbContext>();
        ...
        private async Task<bool> AutoLinkLodestoneForPlayer(Player player, PlayerScopeDbContext context, ILogger<PlayersController> logger)
        {
            try
            {
