...
namespace PlayerScopeServer.Data
{
    public class PlayerScopeDbContext : DbContext
    {
        public PlayerScopeDbContext(DbContextOptions<PlayerScopeDbContext> options) : base(options)
        {
        }
