...
using PlayerScopeServer.Middleware;
...
builder.Services.AddDbContext<PlayerScopeDbContext>(options =>
{
...
{
    var context = scope.ServiceProvider.GetRequiredService<PlayerScopeDbContext>();
    try
    {
