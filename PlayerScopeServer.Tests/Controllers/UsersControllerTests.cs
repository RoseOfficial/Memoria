...
public class UsersControllerTests : IDisposable
{
    ...
    {
        // Arrange
        var request = new PlayerScopeServer.Models.DTOs.UserRegister
        {
    ...
    public async Task Login_ShouldHandleDatabaseConcurrency()
    {
        ...
        var request1 = new PlayerScopeServer.Models.DTOs.UserRegister
        {
            GameAccountId = 123456789,
            UserLocalContentId = 987654321,
            Name = "TestUser1",
        ...
        var request2 = new PlayerScopeServer.Models.DTOs.UserRegister
        {
            GameAccountId = 123456789,
            UserLocalContentId = 987654321,
            Name = "TestUser2",
