If you **don't** want your character to be included in Memoria, you can use this form to opt out. - https://forms.gle/pzfmE8PYak2tH91M8
...
I want to give credit to some plugins that helped me while developing **Memoria**

- **[RetainerTrack](https://git.carvel.li/liza/RetainerTrack)** - [(repo)](https://plugins.carvel.li/) by liza: I built Memoria directly on top of RetainerTrack. Its structure and features made it much easier to implement the functionality I needed. Without it, it would have been impossible for me to create this plugin.
