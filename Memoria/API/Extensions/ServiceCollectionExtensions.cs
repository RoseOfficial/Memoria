...
{
    /// <summary>
    /// Extension methods for IServiceCollection to register Memoria API services
    ...
    {
        /// <summary>
        /// Registers all Memoria API services with the dependency injection container.
        ...
        /// {
        ///     options.BaseUrl = "https://api.memoria.example.com/v1/";
        ///     options.TimeoutSeconds = 30;
        ///     options.MaxRetryAttempts = 3;
        /// });
        /// </code>
        /// </example>
        public static IServiceCollection AddMemoriaApi(
        ...
        /// <summary>
        /// Registers Memoria API services with explicit configuration instance.
        ...
        /// if (!serviceProvider.ValidateMemoriaApiServices())
        /// {
        ///     throw new InvalidOperationException("Failed to register Memoria API services properly");
        /// }
        /// </code>
        /// </example>
        public static bool ValidateMemoriaApiServices(this IServiceProvider serviceProvider)
        {
        ...
        /// <example>
        /// <code>
        /// services.AddMemoriaApiWithCustomClient(provider =>
        /// {
        ...
        /// </code>
        /// </example>
        public static IServiceCollection AddMemoriaApiWithCustomClient(
            this IServiceCollection services,
