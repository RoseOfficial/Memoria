...
/// <summary>
/// Main plugin class for Memoria - a FFXIV Dalamud plugin that tracks player data.
...
public sealed class Plugin : IDalamudPlugin
{
    ...
    /// <summary>
    /// HTTP client for communicating with MemoriaServer API
    /// </summary>
    ...
    /// <summary>Floating micro-card window for the right-click "View in Memoria" use case.</summary>
    ...
    /// <summary>
    /// Initializes the Memoria plugin with dependency injection from Dalamud.
        ...
        IPlayerState playerState)
    {
        ...
        // Register Memoria API services using extension method
        serviceCollection.AddMemoriaApi(Configuration, options =>
        {
        ...
        // Register Memoria-specific game services
        ...
        _commandManager.AddHandler("/memoria", new CommandInfo(ProcessCommand)
        {
    ...
    public void Dispose()
    {
        ...
        _commandManager.RemoveHandler("/memoria");
    ...
    private void MigrateConfiguration(IDalamudPluginInterface pluginInterface)
    {
        ...
        // Migrate to version 4: Add WebBaseUrl and opt-out settings
        if (Configuration.Version < 4)
        {
            Configuration.WebBaseUrl = "https://memoria.gg";
