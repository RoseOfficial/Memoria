...
public class ApiClientTests : IDisposable
{
    ...
    {
        var act = () => new ApiClient(_mockLogger, null!, new Memoria.Configuration());
    ...
    {
        var client = new ApiClient(_mockLogger, null!, new Memoria.Configuration());
    ...
    {
        var config1 = new Memoria.Configuration();
        var config2 = new Memoria.Configuration();
