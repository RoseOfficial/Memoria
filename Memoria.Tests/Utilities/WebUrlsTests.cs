...
namespace Memoria.Tests.Utilities;

public class WebUrlsTests
{
    private const string DefaultBase = "https://memoria.gg";
    ...
    public void ProfileUrl_WithSimpleNameAndWorld_ReturnsExpectedSlug()
    {
        ...
        url.Should().Be("https://memoria.gg/c/Kael-Thalindor@Gilgamesh");
    }
    ...
    public void ProfileUrl_WithApostrophe_PercentEncodesIt()
    {
        ...
        url.Should().Be("https://memoria.gg/c/Y%27shtola-Rhul@Mateus");
    }

    [Fact]
    public void ProfileUrl_TrimsTrailingSlashFromBase()
    {
        var url = WebUrls.ProfileUrl("https://memoria.gg/", "A B", "Faerie");

        url.Should().Be("https://memoria.gg/c/A-B@Faerie");
    }

    [Fact]
    public void MeUrl_ReturnsExpectedPath()
    {
        WebUrls.MeUrl(DefaultBase).Should().Be("https://memoria.gg/me");
    }

    [Fact]
    public void LandingUrl_ReturnsBaseUrl()
    {
        WebUrls.LandingUrl(DefaultBase).Should().Be("https://memoria.gg");
    }
