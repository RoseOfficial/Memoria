...
namespace AlphaScope.Tests.API.Extensions
{
    /// <summary>
    /// Tests for the ServiceCollectionExtensions to ensure proper dependency injection
    /// registration and service resolution for AlphaScope API services.
    /// </summary>
    public class ServiceCollectionExtensionsTests
    {
        /// <summary>
        /// Tests that AddAlphaScopeApi extension method registers all required services
        /// and they can be resolved properly from the service provider.
        /// </summary>
        [Fact]
        public void AddAlphaScopeApi_RegistersAllServices_SuccessfullyResolvesServices()
        {
            // Arrange
        ...
        /// <summary>
        /// Tests that AddAlphaScopeApi without explicit configuration works with defaults.
        /// </summary>
        [Fact]
        public void AddAlphaScopeApi_WithoutConfiguration_UsesDefaults()
        {
            // Arrange
            var services = new ServiceCollection();
            services.AddLogging();
        ...
        /// <summary>
        /// Tests that ValidateAlphaScopeApiServices extension method correctly validates
        /// that all required services are registered and can be resolved.
        /// </summary>
        [Fact]
        public void ValidateAlphaScopeApiServices_WithProperRegistration_ReturnsTrue()
        {
            // Arrange
            var services = new ServiceCollection();
            services.AddLogging();
            ...
            services.AddAlphaScopeApi(config);

            using var serviceProvider = services.BuildServiceProvider();

            // Act
            var isValid = serviceProvider.ValidateAlphaScopeApiServices();
        ...
        /// <summary>
        /// Tests that ValidateAlphaScopeApiServices returns false when required services
        /// are not registered properly.
        /// </summary>
        [Fact]
        public void ValidateAlphaScopeApiServices_WithMissingServices_ReturnsFalse()
        {
            // Arrange
            var services = new ServiceCollection();
            services.AddLogging();
            // Not registering AlphaScope services
        ...
        /// </summary>
        [Fact]
        public void AddAlphaScopeApi_MultipleConfigurations_LastConfigurationWins()
        {
            // Arrange
            var services = new ServiceCollection();
            services.AddLogging();
            ...
            services.AddAlphaScopeApi(); // This will apply defaults but should preserve existing config
        ...
        /// </summary>
        [Fact]
        public void AddAlphaScopeApi_ServiceLifetimes_AreSingleton()
        {
            // Arrange
            var services = new ServiceCollection();
            services.AddLogging();
        ...
        /// </summary>
        [Fact]
        public void AddAlphaScopeApiWithCustomClient_CustomFactory_UsesCustomClient()
        {
            // Arrange
            var services = new ServiceCollection();
            services.AddLogging();
            ...
            // Act
            services.AddAlphaScopeApiWithCustomClient(provider => customRestClient);
